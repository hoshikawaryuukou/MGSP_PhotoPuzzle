...
namespace Runtime.Presenters
{
    public sealed class GameOptionPresenter : IStartable, IDisposable
    {
        ...
        public GameOptionPresenter(GameStore gameStore, GameOptionStore optionStore, GameOptionModal gameOptionScreen)
        {
        ...
        void IStartable.Start()
        {
            ...
            gameStore.AskedSubject.Subscribe(_ => OnAsked()).AddTo(disposables);
            gameStore.PlaySubject.Subscribe(_ => gameOptionScreen.Hide()).AddTo(disposables);
